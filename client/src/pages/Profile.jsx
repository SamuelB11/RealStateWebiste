        ...
        <div className='p-3 max-w-lg mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
                ...
                <p className='text-sm self-center'>
                    {fileUploadError ? (<span className='text-red-800'>Error Image Upload</span>) : filePerc > 0 && filePerc < 100 ? (<span>{`Uploading ${filePerc}%`}</span>) : filePerc === 100 ? (<span className='text-green-400'>Image succesfully uploaded!</span>) : ""}
                </p>
                ...
                <div className='flex justify-between mt-5'>
                    ...
                    <span onClick={handleSignOut} className='text-red-900 cursor-pointer'>Log Out</span>
                </div>
                <span className='text-red-900'> {error ? error : ""} </span>
                <span className='text-green-700'> {updateSuccess ? "Successfully updated" : ""} </span>
            </form>
        </div>
    );
}
